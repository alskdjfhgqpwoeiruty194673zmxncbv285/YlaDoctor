...
public class SplashScreenSecondFragment extends Fragment{
	@OnClick(R.id.generalFragmentSplashScreenTwo_button_nextSplashScreen)
	public void OnNextSplashScreen () {
		nextSplashScreen();
	}

	@OnClick(R.id.generalFragmentSplashScreenTwo_button_previousSplashScreen)
	...
	public View onCreateView ( LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState ) {
		return inflater.inflate(R.layout.general_fragment_splashscreen_two,container,false);
	}
